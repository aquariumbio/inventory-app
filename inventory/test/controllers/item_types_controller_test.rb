...
class ItemTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create item_type" do
    assert_difference('ItemType.count') do
      post item_types_url, params: { item_type: { container_type_id: @item_type.container_type_id, format_type_class: @item_type.format_type_class, format_type_id: @item_type.format_type_id } }
    end
  ...
  test "should update item_type" do
    patch item_type_url(@item_type), params: { item_type: { container_type_id: @item_type.container_type_id, format_type_class: @item_type.format_type_class, format_type_id: @item_type.format_type_id } }
