...
class SingleItemTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create single_item_type" do
    assert_difference('SingleItemType.count') do
      post single_item_types_url, params: { single_item_type: { physical_state_type_id: @single_item_type.physical_state_type_id, sample_type_id: @single_item_type.sample_type_id } }
    end
  ...
  test "should update single_item_type" do
    patch single_item_type_url(@single_item_type), params: { single_item_type: { physical_state_type_id: @single_item_type.physical_state_type_id, sample_type_id: @single_item_type.sample_type_id } }
